...
from utils import plot_learning_curve, rns_reward
...
def rf_train():
    ...
    plot_learning_curve(episodes, avg_rewards, 'Reward', 'reward', "/home/nlsde/RLmodel/PR-v2/adachain/RF3_reward_3e4steps.png")
    rns_reward('/home/nlsde/RLmodel/PR-v2/adachain/adachain_3e4reward.pkl', 'save', avg_rewards)
