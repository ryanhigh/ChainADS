...
parser.add_argument('--ckpt_dir', type=str, default='/home/nlsde/RLmodel/Version10/exp2_baseline/online-fixnum/')
parser.add_argument('--reward_path', type=str, default='/home/nlsde/RLmodel/Version10/exp2_baseline/online-fixnum/wB_avg_reward.png')
parser.add_argument('--epsilon_path', type=str, default='/home/nlsde/RLmodel/Version10/exp2_baseline/online-fixnum/wB_avg_epsilon.png')
...
def ppo_train():
    ...
    rns_reward(args.ckpt_dir+'ppo_fusion_wB_reward.pkl', 'save', avg_rewards)
