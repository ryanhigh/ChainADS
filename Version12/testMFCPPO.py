import numpy as np
import argparse
from MFCPPO import PPO
from wenv import CustomEnv
from utils import plot_learning_curve, create_directory, rns_reward

parser = argparse.ArgumentParser()
parser.add_argument('--max_episodes', type=int, default=200)
parser.add_argument('--ckpt_dir', type=str, default='/home/nlsde/RLmodel/Version12/exp2_baseline/online-c/')
parser.add_argument('--reward_path', type=str, default='/home/nlsde/RLmodel/Version12/exp2_baseline/online-c/wC_avg_reward.png')
parser.add_argument('--epsilon_path', type=str, default='/home/nlsde/RLmodel/Version12/exp2_baseline/online-c/wC_avg_epsilon.png')
...
def ppo_train():
    ...
    agent = PPO(state_dim=11, action_dim=env.action_space.n,lr_actor=0.0003, lr_critic=0.001, gamma=0.99, K_epochs=80, eps_clip=0.2)
    ...
    rns_reward(args.ckpt_dir+'ppo_mfc_wC_reward_2.pkl', 'save', avg_rewards)
