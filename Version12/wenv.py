...
from MFC import compute_kde_or_mean

# Read CSV files for action space and state data
# action_space_df = pd.read_csv('/home/nlsde/RLmodel/Version12/src/workload2/2action.csv')
# action_space = action_space_df.values.tolist()
# state_df1 = pd.read_csv('/home/nlsde/RLmodel/Version12/src/workload2/2output_16.csv')
# state_df2 = pd.read_csv('/home/nlsde/RLmodel/Version12/src/workload2/2output_17.csv')
# state_df3 = pd.read_csv('/home/nlsde/RLmodel/Version12/src/workload2/2output_18.csv')
# state_df4 = pd.read_csv('/home/nlsde/RLmodel/Version12/src/workload2/2output_20.csv')
...
state_space = compute_kde_or_mean(state_space_df1, state_space_df2, state_space_df3, state_space_df4)
