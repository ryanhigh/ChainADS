...
parser.add_argument('--reward_path', type=str, default='/home/nlsde/RLmodel/Version2/baseline/PPO-wC/wC_avg_reward_test.png')
...
def ppo_test():
    ...
    total_test_episodes = 10                         # test episodes num
