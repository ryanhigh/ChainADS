...
parser.add_argument('--max_episodes', type=int, default=int(8e4))
parser.add_argument('--ckpt_dir', type=str, default='/home/nlsde/RLmodel/Version2/baseline/ddqn-wD-online/')
parser.add_argument('--reward_path', type=str, default='/home/nlsde/RLmodel/Version2/baseline/ddqn-wD-online/wD_avg_reward.png')
parser.add_argument('--epsilon_path', type=str, default='/home/nlsde/RLmodel/Version2/baseline/ddqn-wD-online/wD_avg_epsilon.png')
...
def ddqn_train(max_episodes):
    ...
    for episode in range(max_episodes):
        ...
        print('EP:{:<5} reward:{:<20} avg_reward:{:<20} epsilon:{:>10}'.
              format(episode + 1, 500 * reward, avg_reward, agent.epsilon))
    ...
    rns_reward(args.ckpt_dir+'ddqn_wD_reward_online.pkl', 'save', avg_rewards)
