...
def process_state_space(state_space_df1, state_space_df2, state_space_df3, state_space_df4, type):
    ...
    if type == 1:
        ...
        state_space0 = pd.concat([state_space_df1, state_space_df2, state_space_df3, state_space_df4], ignore_index=True)
...
state_space = process_state_space(state_space_df1, state_space_df2, state_space_df3, state_space_df4, 5)
