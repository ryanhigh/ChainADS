...
parser.add_argument('--ckpt_dir', type=str, default='/home/nlsde/RLmodel/Version5/exp5_baseline/')
parser.add_argument('--reward_path', type=str, default='/home/nlsde/RLmodel/Version5/exp5_baseline/EP10000avg_reward.png')
parser.add_argument('--epsilon_path', type=str, default='/home/nlsde/RLmodel/Version5/exp5_baseline/EP10000epsilon.png')

args = parser.parse_args()

def ppo_train():
    env = CustomEnv()
    agent = PPO(state_dim=44, action_dim=env.action_space.n,lr_actor=0.001, lr_critic=0.001, gamma=0.99, K_epochs=80, eps_clip=0.4)
