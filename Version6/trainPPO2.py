...
from wenv2 import CustomEnv
from utils import plot_learning_curve, create_directory
import time

parser = argparse.ArgumentParser()
parser.add_argument('--max_episodes', type=int, default=200)
parser.add_argument('--ckpt_dir', type=str, default='/home/nlsde/RLmodel/Version6/exp5_baseline/')
parser.add_argument('--reward_path', type=str, default='/home/nlsde/RLmodel/Version6/exp5_baseline/EP10000avg_reward.png')
parser.add_argument('--epsilon_path', type=str, default='/home/nlsde/RLmodel/Version6/exp5_baseline/EP10000epsilon.png')

args = parser.parse_args()

def ppo_train():
    env = CustomEnv()
    agent = PPO(system_state_dim=6, node_state_dim=5, action_dim=env.action_space.n,lr_actor=0.0001, lr_critic=0.0001, gamma=0.99, K_epochs=80, eps_clip=0.4)
