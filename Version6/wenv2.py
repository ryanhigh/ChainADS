...
action_space_df = pd.read_csv('/home/nlsde/RLmodel/Version9/src/action.csv')
action_space = action_space_df.values.tolist()
state_df1 = pd.read_csv('/home/nlsde/RLmodel/Version9/src/transformed_data12_modified.csv')
state_df2 = pd.read_csv('/home/nlsde/RLmodel/Version9/src/transformed_data13_modified.csv')
state_df3 = pd.read_csv('/home/nlsde/RLmodel/Version9/src/transformed_data14_modified.csv')
state_df4 = pd.read_csv('/home/nlsde/RLmodel/Version9/src/transformed_data11_modified.csv')

#Deal with NaN
state_space_df = state_df1.fillna(state_df1.shift())
state_space_df2 = state_df2.replace([np.inf, -np.inf], np.nan)
state_space_df3 = state_df3.replace([np.inf, -np.inf], np.nan)
state_space_df4 = state_df4.replace([np.inf, -np.inf], np.nan)
...
if state_space_df1.isnull().values.any():
    state_space_df1 = state_space_df1.fillna(state_space_df1.shift())
...
class CustomEnv(gym.Env):
    ...
    def step(self, action):
        ...
        period, gaslimit, number, transactionpool, connection, position = selected_action
        #change
